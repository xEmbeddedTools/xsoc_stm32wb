                                                                                 ...
                                                                                 Pin* a_p_pin)
{
    ...
    hkm_assert((0 == this->p_port->idx && (9 == a_id || 10 == a_id)) || // PORTA
               (1 == this->p_port->idx && (6 == a_id || 7 == a_id)) ||  // PORTB
               /* DE (RTS pin) */                                       //
               (0u == this->p_port->idx && 12u == a_id) ||              // PORTA
               (1u == this->p_port->idx && 3u == a_id)                  // PORTB
    );
#endif
